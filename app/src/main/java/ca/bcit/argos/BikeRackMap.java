...
public class BikeRackMap extends FragmentActivity implements OnMapReadyCallback {
    ...
    private class AddBikeRacks extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(BikeRackMap.this);
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()) {
                            ...
                            Toast.makeText(BikeRackMap.this, "Unable to get " +
